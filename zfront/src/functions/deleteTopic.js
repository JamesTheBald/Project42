...
const deleteTopic = (topicDraft, topicsDataArray, setTopicsDataArray, currTopicIndex, setShowTopicModal, creatingTopicFlag) => {
  ...
  if (!creatingTopicFlag && (topicsDataArray?.[currTopicIndex]?._id)) {   
    ...
    console.log("TopicModal.js Clicked Delete Topic creatingTopicFlag=", creatingTopicFlag);
    console.log("TopicModal.js Clicked Delete Topic topicDraft=", topicDraft);
    console.log("TopicModal.js Clicked Delete Topic topicsDataArray=", topicsDataArray);

    deleteTopicFromDB(topicsDataArray, currTopicIndex);
