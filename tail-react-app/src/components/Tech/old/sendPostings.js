...
function submitNewPosting(){
  ...
  fetch('http://localhost:8083/postings', {                              // send a post to postings to create the new posting
      method: 'post',                                                    // Update above line to use varible port instead of hard-coded 8083
